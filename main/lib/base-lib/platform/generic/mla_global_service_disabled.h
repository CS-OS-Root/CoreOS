...
inline mla_string_t mla_private_disabled_service_get_install_summary(const mla_string_t &p_ServiceName, const mla_string_t &p_ServiceArgs) {
    (void)p_ServiceName;
    (void)p_ServiceArgs;
...
const mla_service_platform_t g_mla_service_platform = {
    ...
    mla_private_disabled_service_get_install_summary
};
